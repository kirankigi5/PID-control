...
const char *ssid = "KIRAN";   // your network SSID (name)
const char *password = "kibukibu"; // your network password
...
String serverName = "https://esw-onem2m.iiit.ac.in/~/in-cse/in-name/Team-31/Node-1/Data";
HTTPClient http;
const char *origin = "wDbT#6:HUXDQ!";
...
void setup()
{
    ...
    Serial.print("client connection began");
}
...
//    //    }
    ...
    String label2 = "rpm voltage Kp Ki Kd";
    String final_data = String(rpm) + ", " + String(voltage) + ", " + String(Kp) + ", " + String(Ki) + ", " + String(Kd);
    String httpRequestData = String() + "{\"m2m:cin\": {"
